var TableAdvanced = function () {
    ...
    var initTable1 = function() {
        ...
        function fnFormatDetails ( oTable, nTr )
        {
            ...
            var sOut = '<table>';
            sOut += '<tr><td>IP地址:</td><td>'+aData[2]+'</td></tr>';
            sOut += '<tr><td>CPU状态:</td><td>'+aData[3]+'</td></tr>';
            sOut += '<tr><td>内存状态:</td><td>'+aData[4]+'</td></tr>';
            sOut += '<tr><td>硬盘状态:</td><td>'+aData[5]+'</td></tr>';
            sOut += '<tr><td>服务器状态:</td><td>'+aData[6]+'</td></tr>';
            sOut += '</table>';
